...
std::vector<Brick *> Wall::getBricks() { return this->bricks; }

void Wall::setBricks(std::vector<Brick *> bricks) { this->bricks = bricks; }
...
std::string Wall::getSongFileName() { return this->songFileName; }

std::string Wall::getSongKey() { return this->songKey; }

void Wall::setSongFileName(std::string songFileName) { this->songFileName = songFileName; }

void Wall::setSongKey(std::string songKey) { this->songKey = songKey; }

void Wall::playSong() {}

void Wall::resetSong() { Mix_RewindMusic(); }

void Wall::initSong(std::string key) { Mix_PlayMusic(InitUtils::getInstance()->getMixMusic(key), -1); }

void Wall::stopSong() { Mix_HaltMusic(); }
